...
from order.views import show_main_penjual, show_main_pembeli, edit_status_penjual, edit_status_batal, flutter_get_og_by_id
...
urlpatterns = [
    ...
    # * FLUTTER API * #
    path('api/v1/order_group/<int:id>', flutter_get_og_by_id, name='flutter_get_og_by_id'),
]
